...
bool Controller::createSceneTriangle() {
...
bool Controller::createSceneBox(vec3 minPoint, vec3 maxPoint) {
    // Create a single Box
    scene = make_shared<Scene>();
    //1.0 vector de escala que se utiliza para ajustar el tamaño, 1:: tendra su tamaño original.
    auto box = make_shared<Box>(minPoint, maxPoint, 1.0);
